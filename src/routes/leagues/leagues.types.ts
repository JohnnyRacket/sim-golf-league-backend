...
export const leagueSchema = {
  ...
  properties: {
    ...
    payment_type: {
      type: "string",
      enum: ["weekly", "monthly", "upfront", "free"],
    },
    day_of_week: {
      type: "string",
      enum: [
    ...
    scheduling_format: {
      type: "string",
      enum: ["round_robin", "groups", "swiss", "ladder", "custom"],
    },
    playoff_format: {
      type: "string",
      enum: ["none", "single_elimination", "double_elimination", "round_robin"],
    },
